...
action.slackalert.param.url = <string>
...
action.slackalert.param.title = <string>
action.slackalert.param.author_name = <string>
action.slackalert.param.author_link = <string>
action.slackalert.param.author_icon = <string>
action.slackalert.param.title_link = <string>
action.slackalert.param.image_url = <string>
action.slackalert.param.thumb_url = <string>
